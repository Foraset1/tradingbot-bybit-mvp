...
Версия: `0.1`  
Статус: сбор данных, без торговых полномочий
...
|---|---|---|
| 1. Collector | качественные публичные данные и health monitoring | нет |
| 2. Dataset | проверки пропусков, признаки, labels, versioned dataset | нет |
...
проверить схему, coverage, causal timestamps, пропуски, дубликаты, стакан, задержку, остаточные
`.partial`-файлы и зафиксировать fingerprint входных сегментов. Операционная процедура описана
в [`SOAK_TEST.md`](SOAK_TEST.md).
